...
var _g_map = __webpack_require__(27);
...
document.addEventListener('DOMContentLoaded', function () {
  _reactDom2.default.render(_react2.default.createElement(_g_map2.default, null), document.getElementById('main'));
});
  ...
  _createClass(GMap, [{
    ...
    value: function componentDidMount() {
      ...
      google.maps.event.addListener(this.drawingManager, 'overlaycomplete', function (e) {
        ...
        _this2.drawingManager.setDrawingMode(null);
    ...
    key: 'setCurrentShape',
    value: function setCurrentShape(shape) {
      if (this.currentPolygon) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h3',
          null,
          'Paul Angland Solar Calculator Prototype'
        ),
        _react2.default.createElement(
          'p',
          null,
        ...
        _react2.default.createElement(
          'div',
          { className: 'polygon-buttons' },
          _react2.default.createElement(
            'button',
            { onClick: this.beginPolygon },
            ' Select Area '
          ),
          _react2.default.createElement(
            'button',
...
var calculateNominalPower = exports.calculateNominalPower = function calculateNominalPower(area) {
  var wattagePerMeter = 150; // values taken from seemingly reputable
